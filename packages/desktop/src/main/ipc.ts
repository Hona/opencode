...
function browserLayout(input: unknown): BrowserPaneLayout | undefined {
  ...
  if (typeof input.attached !== "boolean" || typeof input.visible !== "boolean") return
  if (input.destroy !== undefined && typeof input.destroy !== "boolean") return
  if (input.background !== undefined && typeof input.background !== "string") return
  if (input.sessionID !== undefined && typeof input.sessionID !== "string") return
  if (input.bounds !== undefined) {
    if (!record(input.bounds)) return
    if (
