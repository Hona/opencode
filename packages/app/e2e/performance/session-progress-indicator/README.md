...
Open `http://127.0.0.1:6007/?count=800` for an equal-count comparison. Use the controls to select 200 indicators, 800 indicators, or as many indicators as fit in the viewport. Large legacy counts can block first paint.
