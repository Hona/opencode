export const dict = {
  ...
  "ui.sessionReviewV2.empty.noGit.action": "สร้าง Git repository",
  "ui.sessionReviewV2.empty.noGit.actionLoading": "กำลังสร้าง Git repository...",
  ...
  "ui.sessionTurn.diffs.changed": "จำนวนไฟล์ที่เปลี่ยนแปลง: {{count}}",
