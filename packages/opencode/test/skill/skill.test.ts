...
`,
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      expect(testSkill!.location).toContain(path.join("skill", "test-skill", "SKILL.md").replaceAll("\\", "/"))
    },
  })
})
...
`,
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      expect(claudeSkill!.location).toContain(
        path.join(".claude", "skills", "claude-skill", "SKILL.md").replaceAll("\\", "/"),
      )
    },
  })
})
    ...
    await Instance.provide({
      ...
      fn: async () => {
        ...
        expect(skills[0].location).toContain(
          path.join(".claude", "skills", "global-test-skill", "SKILL.md").replaceAll("\\", "/"),
        )
      },
    })
  } finally {
...
`,
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      expect(agentSkill!.location).toContain(
        path.join(".agents", "skills", "agent-skill", "SKILL.md").replaceAll("\\", "/"),
      )
    },
  })
})
...
`,
    ...
    await Instance.provide({
      ...
      fn: async () => {
        ...
        expect(skills[0].location).toContain(
          path.join(".agents", "skills", "global-agent-skill", "SKILL.md").replaceAll("\\", "/"),
        )
      },
    })
  } finally {
