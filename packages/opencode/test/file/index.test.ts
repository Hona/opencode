    ...
    test("search refreshes after init when files change", async () => {
      ...
      await Instance.provide({
        ...
        fn: async () => {
          ...
          expect(result).toContain(Path.repo("fresh.ts"))
        },
      })
    })
  })
    ...
    test("two directories get independent file caches", async () => {
      ...
      await Instance.provide({
        ...
        fn: async () => {
          ...
          expect(results).toContain(Path.repo("a.ts"))
      ...
      await Instance.provide({
        ...
        fn: async () => {
          ...
          expect(results).toContain(Path.repo("b.ts"))
    ...
    test("disposal gives fresh state on next access", async () => {
      ...
      await Instance.provide({
        ...
        fn: async () => {
          ...
          expect(results).toContain(Path.repo("before.ts"))
        },
      })
      ...
      await Instance.provide({
        ...
        fn: async () => {
          ...
          expect(results).toContain(Path.repo("after.ts"))
