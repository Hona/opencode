                  ...
                  >
                    <div data-slot="session-timeline-notice" class={`w-full py-1 ${padding()}`}>
                      <div class="flex min-h-5 min-w-0 items-center gap-2 overflow-hidden">
                        <bdi
                          dir="auto"
                          class="shrink-0 text-[13px] font-[530] leading-v2-compact tracking-[-0.04px] text-v2-text-text-faint"
                        >
                          {content().label}
                        </bdi>
                        <For each={content().items}>
                          {(item) => (
                            <bdi
                              dir="auto"
                              class="min-w-0 truncate text-[13px] font-[440] leading-v2-compact tracking-[-0.04px] text-v2-text-text-faint"
                            >
                              {item}
                            </bdi>
                          )}
          ...
          >
            {(message) => (
              <div
                ...
                class={`flex h-7 w-full min-w-0 items-center gap-2 py-1 text-[13px] leading-v2-compact tracking-[-0.04px] text-v2-text-text-faint ${padding()}`}
              >
                <Tooltip
                  appearance="compact"
                  placement="top"
