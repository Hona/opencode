    ...
    return (
      ...
      >
        <div
          ...
          class="flex h-9 w-fit max-w-full items-center gap-2 rounded-[8px] bg-v2-background-bg-layer-01 p-2.5 text-[13px] font-[530] leading-v2-compact tracking-[-0.04px]"
        >
